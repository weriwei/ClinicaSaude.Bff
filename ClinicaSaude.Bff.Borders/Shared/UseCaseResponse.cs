   ...
   public class UseCaseResponse<T>
    {
        ...
        public static UseCaseResponse<T> BadRequest(string errorMessage, IEnumerable<ErrorMessage> errors)
        {
            return new(UseCaseResponseKind.BadRequest, errorMessage, errors);
        }
        public static UseCaseResponse<T> BadGateway() => BadGateway(new ErrorMessage[] { new ErrorMessage(ErrorCodes.BadGateway, ErrorMessages.UnexpectedError) });
        ...
        public static UseCaseResponse<T> InternalServerError() => InternalServerError(new ErrorMessage[] { new ErrorMessage(ErrorCodes.UnhandledError, ErrorMessages.UnexpectedError) });
